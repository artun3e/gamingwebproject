...
/**
 * Servlet implementation class DropdownOrderUpdateServlet
 */
@WebServlet("/DropdownOrderUpdateServlet")
public class DropdownOrderUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DropdownOrderUpdateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user.getUserType() == User.userType.Admin){
			...
			session.setAttribute("dropdownupdateorder-error", "You are not authorized!!!!");
			response.setHeader("dropdownupdateorder-error","true");
			return;
		}
