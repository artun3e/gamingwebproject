...
@WebServlet(name = "addmultipletocart", urlPatterns = {"/addmultipletocart"})
public class AddMultipleToCart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("In the doPost of add multiple to cart!!!");
        try {
            ...
            String itemName = request.getParameter("gameName");
