            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-mail"></i> Email</a></li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Compose Email</h2>
										<p>Welcome to Admin Email Page</span></p>
									</div>
								</div>
							</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="view-mail-list sm-res-mg-t-30">
                            ...
                            <div class="row">
                                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12">
                                    <div class="cmp-int-lb cmp-int-lb1 text-right">
                                        <!-- <span>Subject: </span> -->
                                        <span>Subject: </span>
                                        <textarea style="margin-top:-10px;margin-left:90px; width: 1010px;"name="subject"id="subject" rows="1" cols="112" ></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-11 col-md-10 col-sm-10 col-xs-12">
                        ...
                        <div class="cmp-int-box mg-t-20">
                            <div class="text-area">
                            <textarea style="width: 1100px;"name="myMessage"id="myMessage" rows="10" cols="112" placeholder="Write your mail here..."></textarea>
                            </div>
                        </div>
