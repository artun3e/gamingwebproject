							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Games Table</h2>
										<p>Welcome to Tech Market <span class="bread-ntd">Admin Panel Orders Table</span></p>
									</div>
								</div>
							</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Games</h2>
                            <p>This panel is for Admin to insert, update and delete orders.</p>
                        </div>
                         <a class='btn btn-success btn-block btn-lg' href="game_add.jsp"
										style="margin-left: auto; margin-right: auto; display: block; margin-top: 10px; margin-bottom: 10px">ADD ORDER</a>
