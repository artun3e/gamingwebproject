							...
							<div class="col-8" style="margin-left: 14px;">
								<form action='Update_Check.php' method=POST>
									<div class="form-group row" style="margin-left: 14px;">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="ssid" id="ssid" value="" placeholder="Name"/>
										</div>
									</div>
									<div class="form-group row" style="margin-left: 14px;">
										<label class="col-sm-2 col-form-label">Game Name:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="streamer_id" id="streamer_id"  placeholder="Name"/>
										</div>
									</div>
									<div class="form-group row" style="margin-left: 14px;">
									...
									<div class="form-group row" style="margin-left: 14px;">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="streamed_game" />
										</div>
									</div>
									<div class="form-group row" style="margin-left: 14px;">
									...
									<div class="form-group row" style="margin-left: 14px;">
										<label class="col-sm-2 col-form-label">Time_Streamed: </label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="time_streamed" />
										</div>
									</div>
									<div class="form-group row" style="margin-left: 14px;">
										<label class="col-sm-2 col-form-label">Max Viewers: </label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="max_viewers" />
										</div>
									</div>
