   ...
   <body>
      ...
      <div class="container">
       ...
       if(session.getAttribute("user") != null){
	       ...
	       out.println("              <div id=\"aDiv\"  >");
	       out.println("                       <!--             <label for=\"fname\"><i class=\"fa fa-user\" readonly></i> Full Name</label>");
	       out.println("                          <input type=\"text\" id=\"fname\" name=\"firstname\" placeholder=\"John M. Doe\" readonly>");
	       out.println("                          <label for=\"email\"><i class=\"fa fa-envelope\"></i> Email</label>");
	       out.println("                          <input type=\"text\" id=\"email\" name=\"email\" placeholder=\"john@example.com\"readonly> -->");
	       out.println("                       <label for=\"adr\"><i class=\"fa fa-address-card-o\"></i> Address</label>");
	       out.println("                       <input type=\"text\" id=\"adr\" name=\"address\" placeholder=\"542 W. 15th Street\" readonly>");
	       out.println("                       <label for=\"city\"><i class=\"fa fa-institution\"></i> City</label>");
	       out.println("                       <input type=\"text\" id=\"city\" name=\"city\" placeholder=\"New York\" readonly>");
	       out.println("                       <label for=\"phone\" class=\"fa fa-phone\">Phone Number</label>");
	       out.println("                       <input type=\"text\" id=\"phone\" name=\"phone\" placeholder=\"0(5xx)\" readonly>");
	       out.println(" ");
	       out.println("                       <label>");
	       ...
	       out.println("                       <input type=\"text\" id=\"ccnum\" name=\"cardnumber\" placeholder=\"1111-2222-3333-4444\" readonly>");
	       out.println("                       <label for=\"expmonth\">Expiration Date</label>");
	       out.println("                       <input type=\"text\" id=\"expDate\" name=\"expmonth\" placeholder=\"September\" readonly>");
	       out.println("                       <label for=\"cvv\">CVV</label>");
	       out.println("                       <input type=\"text\" id=\"cvv\" name=\"cvv\" placeholder=\"352\" readonly>");
	       out.println("                       </div>");
	       out.println("                    </div>");
	       out.println("                 </div>");
	       out.println("              </div>");
